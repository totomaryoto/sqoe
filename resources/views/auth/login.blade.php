...
<head>
    ...
    <title>Login &mdash; Alat Musik</title>
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet" href="{{ asset('assets_app/modules/bootstrap-social/bootstrap-social.css') }}">
...
<body style="background: #e2e8f0">
                ...
                <div class="row">
                    <div
                        ...
                        <div class="login-brand">
                            <img src="{{ asset('assets_app/img/sqoe.svg') }}" alt="logo" width="100"
    ...
    <script src="{{ asset('assets_app/modules/tooltip.js') }}"></script>
    ...
    <script src="{{ asset('assets_app/modules/moment.min.js') }}"></script>
